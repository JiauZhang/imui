...
def SDL_GetGPUSwapchainTextureFormat(device: SDL_GPUDevice, window: SDL_Window) -> int: ...

def ImGui_ImplSDL3_InitForSDLGPU(arg: SDL_Window, /) -> bool: ...

class SDL_GPUSampleCount(enum.IntEnum):
    SAMPLECOUNT_1 = 0

class ImGui_ImplSDLGPU3_InitInfo:
    def __init__(self) -> None: ...

    @property
    def Device(self) -> SDL_GPUDevice: ...

    @Device.setter
    def Device(self, arg: SDL_GPUDevice, /) -> None: ...

    @property
    def ColorTargetFormat(self) -> int: ...

    @ColorTargetFormat.setter
    def ColorTargetFormat(self, arg: int, /) -> None: ...

    @property
    def MSAASamples(self) -> SDL_GPUSampleCount: ...

    @MSAASamples.setter
    def MSAASamples(self, arg: SDL_GPUSampleCount, /) -> None: ...

def ImGui_ImplSDLGPU3_Init(arg: ImGui_ImplSDLGPU3_InitInfo, /) -> bool: ...
...
class SDL_Event:
    ...
    @property
    def window(self) -> SDL_WindowEvent: ...

    @window.setter
    def window(self, arg: SDL_WindowEvent, /) -> None: ...

class SDL_EventType(enum.Enum):
    QUIT = 256
...
class SDL_WindowEvent:
    ...
    @windowID.setter
    def windowID(self, arg: int, /) -> None: ...

def SDL_PollEvent(arg: SDL_Event, /) -> bool: ...

def SDL_GetWindowID(arg: SDL_Window, /) -> int: ...

def SDL_GetWindowFlags(arg: SDL_Window, /) -> int: ...

def ImGui_ImplSDL3_ProcessEvent(arg: SDL_Event, /) -> bool: ...

def ImGui_ImplSDLGPU3_NewFrame() -> None: ...

def ImGui_ImplSDL3_NewFrame() -> None: ...
